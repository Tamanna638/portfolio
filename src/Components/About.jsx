    ...
    <>
      <div className="relative h-full">
        <div className={`${darkmode==="dark" ? `bg-${bgcolor}` : `bg-white`} p-10 rounded-lg`}>
          ...
          >
            I have Completed My <span className="font-bold">Bachelor of Computer Applications Degree </span>From Shimla Universty  <br /> Himachal Pradesh
            My Specilization in <span className="font-bold"> Computer Applications</span>
          ...
          >
            ...
            creative way. I <br />
            creates <span className="font-bold">web-sites</span> for different screen sizes.<br/>
            <br/>
