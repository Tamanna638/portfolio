      ...
      {/* <div className="about p-3 "> */}
        <div className={` ${darkmode==="dark" ? `bg-${bgcolor}` : `bg-white`} p-10 rounded-lg`}>
          ...
          <div className="flex gap-5 flex-wrap ">
            ...
            >
              <p  style={{ color: `${bgcolor==="white" ? "#000000" : "#A6A6A6"}`}}  >2021-2024</p>
              <h1  style={{ color: `${bgcolor==="white" ? "#000000" : "white"}`}}  >BCA in Shimla University</h1>
            ...
            >
              ...
              <h1 style={{ color: `${bgcolor==="white" ? "#000000" : "white"}`}}>12th Class, Girls Government Senior Secondary School</h1>
              <h1 style={{ color: `${bgcolor==="white" ? "#000000" : "#A6A6A6"}`}}>Nangal Town Ship(Punjab)</h1>
            </div>
            ...
            >
              ...
              <h1 style={{ color: `${bgcolor==="white" ? "#000000" : "white"}`}}>10th Class,Girls Government Senior Secondary School</h1>
              <h1 style={{ color: `${bgcolor==="white" ? "#000000" : "#A6A6A6"}`}}>Nangal Town Ship(Punjab)</h1>
            </div>
          </div>
